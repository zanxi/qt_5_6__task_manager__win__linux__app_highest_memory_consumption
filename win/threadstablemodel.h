...
public:
    ...
    QStackedBarSeries* getStackedBarSeriesForPid(DWORD pid);
...
private:
    ...
    QMap<DWORD, QStackedBarSeries*> stackedBarSeriesMap;
    ...
    QMap<DWORD, QBarSet*> kernelTimeMapPidBarSet;

    QMap<DWORD, QBarSet*> userTimeMapPidBarSet;

    QBarSet* getKernelTimeBarSetForPid(DWORD pid);

    QBarSet* getUserTimeBarSetForPid(DWORD pid);
